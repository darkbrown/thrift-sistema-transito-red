 ...
 * @author cris_
 */
public class RegistrarPerito extends javax.swing.JFrame {
    ...
    public RegistrarPerito(String nombre, String usuario, String contrasena) {
        initComponents();
        this.nombre = nombre;
    ...
    private void initComponents() {
        ...
        btnRegistrarPerito.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        ...
        btnRegistrarPerito.setBounds(360, 250, 180, 40);
        ...
        lblUsuario.setBounds(0, 80, 150, 40);
        ...
        txtUsuario.setBounds(160, 80, 380, 40);

        lblPass1.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        lblPass1.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lblPass1.setText("Contraseña");
        jPanel2.add(lblPass1);
        lblPass1.setBounds(0, 130, 150, 40);

        lblPass2.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        lblPass2.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lblPass2.setText("Confirmar Contraseña");
        jPanel2.add(lblPass2);
        lblPass2.setBounds(0, 180, 150, 40);

        txtContrasena2.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jPanel2.add(txtContrasena2);
        txtContrasena2.setBounds(160, 180, 380, 40);

        txtContrasena1.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jPanel2.add(txtContrasena1);
        txtContrasena1.setBounds(160, 130, 380, 40);
        ...
        lblTitulo.setText("REGISTRAR NUEVO PERITO");
    ...
    private void btnRegistrarPeritoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarPeritoActionPerformed
     String nombrePerito, usuarioPerito, contrasena1, contrasena2, cargo;
     ...
     if("".equals(nombrePerito) || "".equals(usuarioPerito) || "".equals(contrasena1) || "".equals(contrasena2) ){
            ...
            if (contrasena1.equals(contrasena2)) {
                if (contrasena1.length() > 7) {
                    ...
                    perito.setCargo(cargo);
                    perito.setEstatus(1);
                    perito.setNombre(nombrePerito);
                    perito.setUsuario(usuarioPerito);
                    perito.setContrasena(conexiones.getSHA256(contrasena1));
                    try {
                        if (conexiones.registrarPerito(perito)) {
                            JOptionPane.showConfirmDialog(null, "El nuevo perito ha sido registrado exitosamente!!", "Registro exitoso", JOptionPane.DEFAULT_OPTION, JOptionPane.INFORMATION_MESSAGE);
                        ...
                        JOptionPane.showConfirmDialog(null, "Error al intentar registrar nuevo perito, intente de nuevo", "Error al guardar", JOptionPane.DEFAULT_OPTION, JOptionPane.INFORMATION_MESSAGE);
                    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegistrarPerito.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
