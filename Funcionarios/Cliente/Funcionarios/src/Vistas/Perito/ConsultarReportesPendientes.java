 ...
 * @author cris_
 */
public class ConsultarReportesPendientes extends javax.swing.JFrame {
    ...
    String nombreConductor, nombreOtroConduc = null;
    Integer idReporte;
    ...
    public ConsultarReportesPendientes(String nombre, String usuario, String contrasena) {
        initComponents();
        this.nombre = nombre;
    ...
    private void btnAsignarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAsignarActionPerformed
        ...
        try {
            if (conexiones.asignarReportePerito(this.usuario, idReporte)) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultarReportesPendientes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
